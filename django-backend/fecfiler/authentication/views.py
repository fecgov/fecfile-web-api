...
class LoginDotGovSuccessSpaRedirect(View):
    def get(self, request, *args, **kwargs):
        ...
        redirect.set_cookie(FFAPI_JWT_COOKIE_NAME, self.request.session.get("oidc_id_token"))
        redirect.set_cookie(FFAPI_COMMITTEE_ID_COOKIE_NAME, request.user.cmtee_id)
