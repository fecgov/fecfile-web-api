...
urlpatterns = [
    ...
    url(
        r"^f99/get_rad_analyst_info$",
        views.get_rad_analyst_info,
        name="get_rad_analyst_info",
    ),
    url(r"^f99/get_form99list$", views.get_form99list, name="get_form99list"),
    url(
        r"^f99/get_previous_amend_reports$",
        views.get_previous_amend_reports,
        name="get_previous_amend_reports",
    ),
    ...
    url(
        r"^core/get_committee_details$",
        views.get_committee_details,
        name="get_committee_details",
    ),
    url(
        r"^core/update_committee_details/(?P<cid>[0-9,a-z,A-Z]+)$",
        views.update_committee,
    ...
    url(
        r"^f99/get_f99_report_info$",
        views.get_f99_report_info,
        name="get_f99_report_info",
    ),
