...
class F3XSummary(SoftDeleteModel):
    ...
    form_type = models.CharField(
        choices=(("F3XT", "F3XT"), ("F3XA", "F3XA"), ("F3XN", "F3XN")),
        max_length=255,
        default="F3XN",
        null=False,
        blank=False,
    ...
    committee_name = models.TextField(
        null=True, blank=True, max_length=200, min_length=0
    )
    change_of_address = models.BooleanField(default=False, null=True, blank=True)
    street_1 = models.TextField(null=True, blank=True, max_length=34, min_length=0)
    street_2 = models.TextField(null=True, blank=True, max_length=34, min_length=0)
    city = models.TextField(null=True, blank=True, max_length=30, min_length=0)
    state = models.TextField(null=True, blank=True, max_length=2, min_length=0)
    zip = models.TextField(null=True, blank=True, max_length=9, min_length=0)
    report_code = models.TextField(null=True, blank=True, max_length=3, min_length=0)
    election_code = models.TextField(null=True, blank=True, max_length=5, min_length=0)
    date_of_election = models.TextField(
        null=True, blank=True, max_length=8, min_length=8
    )
    state_of_election = models.TextField(
        null=True, blank=True, max_length=2, min_length=0
    )
    coverage_from_date = models.TextField(
        null=True, blank=True, max_length=8, min_length=8
    )
    coverage_through_date = models.TextField(
        null=True, blank=True, max_length=8, min_length=8
    )
    qualified_committee = models.BooleanField(default=False, null=True, blank=True)
    treasurer_last_name = models.TextField(
        null=False, blank=False, max_length=30, min_length=0
    )
    treasurer_first_name = models.TextField(
        null=False, blank=False, max_length=20, min_length=0
    )
    treasurer_middle_name = models.TextField(
        null=True, blank=True, max_length=20, min_length=0
    )
    treasurer_prefix = models.TextField(
        null=True, blank=True, max_length=10, min_length=0
    )
    treasurer_suffix = models.TextField(
        null=True, blank=True, max_length=10, min_length=0
    )
    date_signed = models.TextField(null=False, blank=False, max_length=8, min_length=8)
    ...
    L6a_year_for_above_ytd = models.TextField(
        null=True, blank=True, max_length=4, min_length=4
    )
