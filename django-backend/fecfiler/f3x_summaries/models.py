...
class F3XSummary(SoftDeleteModel):
    ...
    form_type = models.CharField(choices=(('F3XT', 'F3XT'), ('F3XA', 'F3XA'), ('F3XN', 'F3XN')), max_length=255, default='F3XN', null=False, blank=False)
    filer_committee_id_number = models.TextField(null=False, blank=False, max_length=9, min_length=0)
    committee_name = models.TextField(null=True, blank=True, max_length=200, min_length=0)
    ...
    date_of_election = models.TextField(null=True, blank=True, max_length=8, min_length=8)
    state_of_election = models.TextField(null=True, blank=True, max_length=2, min_length=0)
    coverage_from_date = models.TextField(null=True, blank=True, max_length=8, min_length=8)
    coverage_through_date = models.TextField(null=True, blank=True, max_length=8, min_length=8)
    qualified_committee = models.BooleanField(default=False, null=True, blank=True)
    treasurer_last_name = models.TextField(null=False, blank=False, max_length=30, min_length=0)
    treasurer_first_name = models.TextField(null=False, blank=False, max_length=20, min_length=0)
    treasurer_middle_name = models.TextField(null=True, blank=True, max_length=20, min_length=0)
    treasurer_prefix = models.TextField(null=True, blank=True, max_length=10, min_length=0)
    treasurer_suffix = models.TextField(null=True, blank=True, max_length=10, min_length=0)
    ...
    L11c_other_political_committees_pacs_period = models.IntegerField(null=True, blank=True)
    L11d_total_contributions_period = models.IntegerField(null=True, blank=True)
    L12_transfers_from_affiliated_other_party_cmtes_period = models.IntegerField(null=True, blank=True)
    ...
    L15_offsets_to_operating_expenditures_refunds_period = models.IntegerField(null=True, blank=True)
    L16_refunds_of_federal_contributions_period = models.IntegerField(null=True, blank=True)
    L17_other_federal_receipts_dividends_period = models.IntegerField(null=True, blank=True)
    L18a_transfers_from_nonfederal_account_h3_period = models.IntegerField(null=True, blank=True)
    L18b_transfers_from_nonfederal_levin_h5_period = models.IntegerField(null=True, blank=True)
    L18c_total_nonfederal_transfers_18a_18b_period = models.IntegerField(null=True, blank=True)
    ...
    L21b_other_federal_operating_expenditures_period = models.IntegerField(null=True, blank=True)
    L21c_total_operating_expenditures_period = models.IntegerField(null=True, blank=True)
    L22_transfers_to_affiliated_other_party_cmtes_period = models.IntegerField(null=True, blank=True)
    L23_contributions_to_federal_candidates_cmtes_period = models.IntegerField(null=True, blank=True)
    L24_independent_expenditures_period = models.IntegerField(null=True, blank=True)
    L25_coordinated_expend_made_by_party_cmtes_period = models.IntegerField(null=True, blank=True)
    ...
    L30ai_shared_federal_activity_h6_fed_share_period = models.IntegerField(null=True, blank=True)
    L30aii_shared_federal_activity_h6_nonfed_period = models.IntegerField(null=True, blank=True)
    L30b_nonallocable_fed_election_activity_period = models.IntegerField(null=True, blank=True)
    L30c_total_federal_election_activity_period = models.IntegerField(null=True, blank=True)
    ...
    L36_total_federal_operating_expenditures_period = models.IntegerField(null=True, blank=True)
    L37_offsets_to_operating_expenditures_period = models.IntegerField(null=True, blank=True)
    ...
    L6a_year_for_above_ytd = models.TextField(null=True, blank=True, max_length=4, min_length=4)
    ...
    L11c_other_political_committees_pacs_ytd = models.IntegerField(null=True, blank=True)
    L11d_total_contributions_ytd = models.IntegerField(null=True, blank=True)
    L12_transfers_from_affiliated_other_party_cmtes_ytd = models.IntegerField(null=True, blank=True)
    ...
    L15_offsets_to_operating_expenditures_refunds_ytd = models.IntegerField(null=True, blank=True)
    L16_refunds_of_federal_contributions_ytd = models.IntegerField(null=True, blank=True)
    L17_other_federal_receipts_dividends_ytd = models.IntegerField(null=True, blank=True)
    L18a_transfers_from_nonfederal_account_h3_ytd = models.IntegerField(null=True, blank=True)
    L18b_transfers_from_nonfederal_levin_h5_ytd = models.IntegerField(null=True, blank=True)
    L18c_total_nonfederal_transfers_18a_18b_ytd = models.IntegerField(null=True, blank=True)
    ...
    L21b_other_federal_operating_expenditures_ytd = models.IntegerField(null=True, blank=True)
    L21c_total_operating_expenditures_ytd = models.IntegerField(null=True, blank=True)
    L22_transfers_to_affiliated_other_party_cmtes_ytd = models.IntegerField(null=True, blank=True)
    L23_contributions_to_federal_candidates_cmtes_ytd = models.IntegerField(null=True, blank=True)
    L24_independent_expenditures_ytd = models.IntegerField(null=True, blank=True)
    L25_coordinated_expend_made_by_party_cmtes_ytd = models.IntegerField(null=True, blank=True)
    ...
    L30ai_shared_federal_activity_h6_fed_share_ytd = models.IntegerField(null=True, blank=True)
    L30aii_shared_federal_activity_h6_nonfed_ytd = models.IntegerField(null=True, blank=True)
    L30b_nonallocable_fed_election_activity_ytd = models.IntegerField(null=True, blank=True)
    L30c_total_federal_election_activity_ytd = models.IntegerField(null=True, blank=True)
