...
class F3XSummary(SoftDeleteModel):
    ...
    committee_name = models.CharField(null=True, blank=True, max_length=200)
    change_of_address = models.BooleanField(default=False, null=True, blank=True)
    street_1 = models.CharField(null=True, blank=True, max_length=34)
    street_2 = models.CharField(null=True, blank=True, max_length=34)
    city = models.CharField(null=True, blank=True, max_length=30)
    state = models.CharField(null=True, blank=True, max_length=2)
    zip = models.CharField(null=True, blank=True, max_length=9)
    report_code = models.CharField(null=True, blank=True, max_length=3)
    election_code = models.CharField(null=True, blank=True, max_length=5)
    date_of_election = models.CharField(null=True, blank=True, max_length=8)
    state_of_election = models.CharField(null=True, blank=True, max_length=2)
    coverage_from_date = models.CharField(null=True, blank=True, max_length=8)
    coverage_through_date = models.CharField(null=True, blank=True, max_length=8)
    qualified_committee = models.BooleanField(default=False, null=True, blank=True)
    treasurer_last_name = models.CharField(null=False, blank=False, max_length=30)
    treasurer_first_name = models.CharField(null=False, blank=False, max_length=20)
    treasurer_middle_name = models.CharField(null=True, blank=True, max_length=20)
    treasurer_prefix = models.CharField(null=True, blank=True, max_length=10)
    treasurer_suffix = models.CharField(null=True, blank=True, max_length=10)
    date_signed = models.CharField(null=False, blank=False, max_length=8)
    ...
    L6a_year_for_above_ytd = models.CharField(null=True, blank=True, max_length=4)
