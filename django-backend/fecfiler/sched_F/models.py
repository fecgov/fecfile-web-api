...
class SchedF(models.Model):
    ...
    coordinated_exp_ind = models.CharField(primary_key=True, max_length=3)
    designating_cmte_id = models.CharField(primary_key=True, max_length=9)
    designating_cmte_name = models.CharField(primary_key=True, max_length=200)
    subordinate_cmte_id = models.CharField(primary_key=True, max_length=9)
    subordinate_cmte_name = models.CharField(primary_key=True, max_length=200)
    subordinate_cmte_street_1 = models.CharField(primary_key=True, max_length=34)
    subordinate_cmte_street_2 = models.CharField(primary_key=True, max_length=34)
    subordinate_cmte_city = models.CharField(primary_key=True, max_length=30)
    subordinate_cmte_state = models.CharField(primary_key=True, max_length=2)
    subordinate_cmte_zip = models.CharField(primary_key=True, max_length=10)
    ...
    payee_cand_state = models.CharField(primary_key=True, max_length=2)
    payee_cand_district= models.CharField(primary_key=True, max_length=2)  
