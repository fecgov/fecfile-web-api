...
from fecfiler.devops.utils.django_key import (
...
class DjangoKeyUtilsTestCase(TestCase):
    ...
    @patch("fecfiler.devops.utils.django_key.retrieve_credentials")
    ...
    @patch("fecfiler.devops.utils.django_key.retrieve_credentials")
    @patch("fecfiler.devops.utils.django_key.update_credentials")
