...
class Form1M(models.Model):
    ...
    committee_type = models.CharField(null=True, blank=True)
    ...
    I_candidate_office = models.CharField(null=True, blank=True)
    ...
    II_candidate_office = models.CharField(null=True, blank=True)
    ...
    III_candidate_office = models.CharField(null=True, blank=True)
    ...
    IV_candidate_office = models.CharField(null=True, blank=True)
    ...
    V_candidate_office = models.CharField(null=True, blank=True)
