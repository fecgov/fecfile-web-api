...
from fecfiler.transactions.schedule_a.models import ScheduleATransaction, ScheduleA
...
class ScheduleASerializer:
    class Meta:
        fields = [
            f.name for f in ScheduleA._meta.get_fields() if f.name not in ["deleted"]
        ]
