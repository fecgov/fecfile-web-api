    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reattribution_redesignation_tag', models.TextField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ScheduleB',
            fields=[
                ...
                ('beneficiary_committee_fec_id', models.TextField(blank=True, null=True)),
                ('beneficiary_committee_name', models.TextField(blank=True, null=True)),
                ('beneficiary_candidate_fec_id', models.TextField(blank=True, null=True)),
                ('beneficiary_candidate_last_name', models.TextField(blank=True, null=True)),
                ('beneficiary_candidate_first_name', models.TextField(blank=True, null=True)),
                ('beneficiary_candidate_middle_name', models.TextField(blank=True, null=True)),
                ('beneficiary_candidate_prefix', models.TextField(blank=True, null=True)),
                ('beneficiary_candidate_suffix', models.TextField(blank=True, null=True)),
                ('beneficiary_candidate_office', models.TextField(blank=True, null=True)),
                ('beneficiary_candidate_state', models.TextField(blank=True, null=True)),
                ('beneficiary_candidate_district', models.TextField(blank=True, null=True)),
                ('memo_text_description', models.TextField(blank=True, null=True)),
                ('reference_to_si_or_sl_system_code_that_identifies_the_account', models.TextField(blank=True, null=True)),
                ('reattribution_redesignation_tag', models.TextField(blank=True, null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('election_code', models.TextField(blank=True, null=True)),
                ('election_other_description', models.TextField(blank=True, null=True)),
                ('loan_amount', models.DecimalField(blank=True, decimal_places=2, max_digits=11, null=True)),
                ...
                ('personal_funds', models.BooleanField(blank=True, default=False, null=True)),
                ...
                ('lender_candidate_first_name', models.TextField(blank=True, null=True)),
                ('lender_candidate_middle_name', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loan_incurred_date', models.DateField(blank=True, null=True)),
                ('loan_due_date', models.TextField(blank=True, null=True)),
                ('loan_restructured', models.BooleanField(blank=True, default=False, null=True)),
                ('loan_originally_incurred_date', models.DateField(blank=True, null=True)),
                ('credit_amount_this_draw', models.DecimalField(blank=True, decimal_places=2, max_digits=11, null=True)),
                ('total_balance', models.DecimalField(blank=True, decimal_places=2, max_digits=11, null=True)),
                ('others_liable', models.BooleanField(blank=True, default=False, null=True)),
                ('collateral', models.BooleanField(blank=True, default=False, null=True)),
                ('desc_collateral', models.TextField(blank=True, null=True)),
                ('collateral_value_amount', models.DecimalField(blank=True, decimal_places=2, max_digits=11, null=True)),
                ('perfected_interest', models.BooleanField(blank=True, default=False, null=True)),
                ('future_income', models.BooleanField(blank=True, default=False, null=True)),
                ('desc_specification_of_the_above', models.TextField(blank=True, null=True)),
                ('estimated_value', models.DecimalField(blank=True, decimal_places=2, max_digits=11, null=True)),
                ...
                ('dep_acct_auth_date_presidential', models.DateField(blank=True, null=True)),
                ...
                ('line_of_credit', models.BooleanField(blank=True, default=False, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ScheduleC2',
            fields=[
                ...
                ('guaranteed_amount', models.DecimalField(blank=True, decimal_places=2, max_digits=11, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ScheduleD',
            fields=[
                ...
                ('purpose_of_debt_or_obligation', models.TextField(blank=True, null=True)),
                ('incurred_amount', models.DecimalField(blank=True, decimal_places=2, max_digits=11, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ScheduleE',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_id', models.TextField(default=fecfiler.shared.utilities.generate_fec_uid)),
                ...
                ('contact_1', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contact_1_transaction_set', to='contacts.contact')),
                ('contact_2', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contact_2_transaction_set', to='contacts.contact')),
                ('contact_3', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contact_3_transaction_set', to='contacts.contact')),
                ('debt', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='debt_associations', to='transactions.transaction')),
                ('loan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='loan_associations', to='transactions.transaction')),
                ...
                ('reatt_redes', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reatt_redes_associations', to='transactions.transaction')),
                ('report', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='reports.report')),
                ('schedule_a', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='transactions.schedulea')),
                ('schedule_b', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='transactions.scheduleb')),
                ('schedule_c', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='transactions.schedulec')),
                ('schedule_c1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='transactions.schedulec1')),
                ('schedule_c2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='transactions.schedulec2')),
                ('schedule_d', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='transactions.scheduled')),
                ('schedule_e', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='transactions.schedulee')),
            ],
            options={
                'indexes': [models.Index(fields=['_form_type'], name='transaction__form_t_e73a46_idx')],
            },
        ),
    ]
