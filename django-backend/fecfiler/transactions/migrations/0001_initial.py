...
def copy_scha_transactions(apps, schema_editor):
    try:
        ...
        transactions_to_copy = SchATransaction.objects.all().annotate(
            conduit_street_1=Value("conduit_street1"),
            conduit_street_2=Value("conduit_street2"),
            parent_transaction_object_id=Value("parent_transaction_id"),
            parent_transaction_content_type=SchATransaction,
        )
