    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('beginning_balance', models.DecimalField(blank=True, decimal_places=2, max_digits=11, null=True)),
                ...
                ('balance_at_close', models.DecimalField(blank=True, decimal_places=2, max_digits=11, null=True)),
            ],
        ),
        migrations.AddField(
            model_name='transaction',
            name='schedule_d',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='transactions.scheduled'),
        ),
    ]
