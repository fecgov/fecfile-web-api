    ...
    def get_queryset(self):
        ...
        return (
            ...
            .annotate(
                ...
                line_label=Case(
                    # Schedule A
                    When(form_type="SA11A", then=Value("11(a)")),
                    When(form_type="SA11AI", then=Value("11(a)(i)")),
                    When(form_type="SA11AII", then=Value("11(a)(ii)")),
                    When(form_type="SA11B", then=Value("11(b)")),
                    When(form_type="SA11C", then=Value("11(c)")),
                    When(form_type="SA12", then=Value("12")),
                    When(form_type="SA13", then=Value("13")),
                    When(form_type="SA14", then=Value("14")),
                    When(form_type="SA15", then=Value("15")),
                    When(form_type="SA16", then=Value("16")),
                    When(form_type="SA17", then=Value("17")),
                    # Schedule B
                    When(form_type="SB21B", then=Value("21(b)")),
                    When(form_type="SB22", then=Value("22")),
                    When(form_type="SB23", then=Value("23")),
                    When(form_type="SB26", then=Value("26")),
                    When(form_type="SB27", then=Value("27")),
                    When(form_type="SB28A", then=Value("28(a)")),
                    When(form_type="SB28B", then=Value("28(b)")),
                    When(form_type="SB28C", then=Value("28(c)")),
                    When(form_type="SB29", then=Value("29")),
                    When(form_type="SB30B", then=Value("30(b)")),
                    # Schedule C
                    When(form_type="SC/10", then=Value("10")),
                    When(form_type="SC/9", then=Value("9")),
                    # Schedule D
                    When(form_type="SD9", then=Value("9")),
                    When(form_type="SD10", then=Value("10")),
                    # Schedule E
                    When(form_type="SE", then=Value("24")),
                ),
