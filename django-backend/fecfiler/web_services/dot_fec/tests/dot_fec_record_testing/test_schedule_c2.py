...
class DotFECScheduleC2TestCase(TestCase):
    ...
    def test_guarantor(self):
        self.assertEqual(self.split_row[4], self.individual.last_name)
        self.assertEqual(self.split_row[5], self.individual.first_name)
        self.assertEqual(self.split_row[6], self.individual.middle_name)
        self.assertEqual(self.split_row[7], self.individual.prefix)
        self.assertEqual(self.split_row[8], self.individual.suffix)
        self.assertEqual(self.split_row[9], self.individual.street_1)
        self.assertEqual(self.split_row[10], self.individual.street_2)
        self.assertEqual(self.split_row[11], self.individual.city)
        self.assertEqual(self.split_row[12], self.individual.state)
        self.assertEqual(self.split_row[13], self.individual.zip)
        self.assertEqual(self.split_row[14], self.individual.employer)
        self.assertEqual(self.split_row[15], self.individual.occupation)
        self.assertEqual(self.split_row[16], "10.00")
