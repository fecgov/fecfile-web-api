...
class F3XReportTestCase(TestCase):
    ...
    def test_calculate_summary_column_a(self):
        ...
        self.assertEqual(sum_a["line_6c"], Decimal("18085.17"))
        self.assertEqual(
            sum_a["line_6d"],
            Decimal("0") +  # line_6b
        ...
        self.assertEqual(sum_a["line_9"], Decimal("225.00"))
        self.assertEqual(sum_a["line_10"], Decimal("250.00"))
        self.assertEqual(sum_a["line_11ai"], Decimal("10000.23"))
        self.assertEqual(sum_a["line_11aii"], Decimal("3.77"))
        self.assertEqual(
            sum_a["line_11aiii"],
            Decimal("10000.23")  # line_11ai
            + Decimal("3.77")  # line_11aii
        )
        self.assertEqual(sum_a["line_11b"], Decimal("444.44"))
        self.assertEqual(sum_a["line_11c"], Decimal("555.55"))
        self.assertEqual(
            sum_a["line_11d"],
            Decimal("10000.23")  # line_11ai
            + Decimal("3.77")  # line_11aii
        ...
        self.assertEqual(sum_a["line_12"], Decimal("1212.12"))
        self.assertEqual(sum_a["line_13"], Decimal("1313.13"))
        self.assertEqual(sum_a["line_14"], Decimal("1414.14"))
        self.assertEqual(sum_a["line_15"], Decimal("2125.79"))
        self.assertEqual(sum_a["line_16"], Decimal("16.00"))
        self.assertEqual(sum_a["line_17"], Decimal("1000.00"))
        self.assertEqual(sum_a["line_19"], Decimal("18085.17"))
        self.assertEqual(sum_a["line_20"], Decimal("18085.17"))
        self.assertEqual(sum_a["line_21b"], Decimal("150.00"))
        self.assertEqual(sum_a["line_21c"], Decimal("150.00"))
        self.assertEqual(sum_a["line_22"], Decimal("22.00"))
        self.assertEqual(sum_a["line_23"], Decimal("14.00"))
        self.assertEqual(sum_a["line_24"], Decimal("141.00"))
        self.assertEqual(sum_a["line_26"], Decimal("44.00"))
        self.assertEqual(sum_a["line_27"], Decimal("31.00"))
        self.assertEqual(sum_a["line_28a"], Decimal("101.50"))
        self.assertEqual(sum_a["line_28b"], Decimal("201.50"))
        self.assertEqual(sum_a["line_28c"], Decimal("301.50"))
        self.assertEqual(
            sum_a["line_28d"],
        ...
        self.assertEqual(sum_a["line_30c"], Decimal("102.25"))
        ...
        self.assertEqual(sum_a["line_33"], sum_a["line_11d"])
        self.assertEqual(sum_a["line_34"], sum_a["line_28d"])
        self.assertEqual(
            sum_a["line_35"],
            sum_a["line_33"]
            - sum_a["line_34"]
        )
        self.assertEqual(sum_a["line_36"], Decimal("150.00"))
        self.assertEqual(sum_a["line_37"], Decimal("2125.79"))
        self.assertEqual(
            sum_a["line_38"],
    ...
    def test_calculate_summary_column_b(self):
        ...
        self.assertEqual(sum_b["line_6c"], Decimal("18985.17"))
        self.assertEqual(
            sum_b["line_6d"],
            Decimal("0")  # line_6a
        ...
        self.assertEqual(sum_b["line_13"], Decimal("1413.13"))
        self.assertEqual(sum_b["line_14"], Decimal("1514.14"))
        self.assertEqual(sum_b["line_15"], Decimal("2225.79"))
        self.assertEqual(sum_b["line_16"], Decimal("116.00"))
        self.assertEqual(sum_b["line_17"], Decimal("1100.00"))
        self.assertEqual(sum_b["line_19"], Decimal("18985.17"))
        self.assertEqual(sum_b["line_20"], Decimal("18985.17"))
        self.assertEqual(sum_b["line_21b"], Decimal("250.00"))
        self.assertEqual(sum_b["line_21c"], Decimal("250.00"))
        self.assertEqual(sum_b["line_22"], Decimal("122.00"))
        self.assertEqual(sum_b["line_23"], Decimal("64.00"))
        self.assertEqual(sum_b["line_24"], Decimal("286.00"))
        self.assertEqual(sum_b["line_26"], Decimal("61.00"))
        self.assertEqual(sum_b["line_27"], Decimal("41.00"))
        self.assertEqual(sum_b["line_28a"], Decimal("1101.50"))
        ...
        self.assertEqual(sum_b["line_30c"], Decimal("1102.25"))
