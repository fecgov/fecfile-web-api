...
class F3X(models.Model):
    ...
    date_of_election = models.IntegerField(null=True, blank=True)
    state_of_election = models.CharField(null=True, blank=True, max_length=2)
    coverage_from_date = models.IntegerField(null=True, blank=True)
    coverage_through_date = models.IntegerField(null=True, blank=True)
    ...
    date_signed = models.IntegerField(null=False, blank=False)
    ...
    L6a_year_for_above_ytd = models.IntegerField(null=True, blank=True)
