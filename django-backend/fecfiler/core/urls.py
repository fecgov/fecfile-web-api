...
urlpatterns = [
    ...
    #url(r'^core/build_form3x_json_file$', jsonbuilder.build_form3x_json_file, name='build_form3x_json_file'),
    url(r'^core/create_f3x_partner_json_file$',
        jsonbuilder.create_f3x_partner_json_file, name='create_f3x_partner_json_file'),
    url(r'^core/create_f3x_json_file$',
        jsonbuilder.create_f3x_json_file, name='create_f3x_json_file'),
    url(r'^core/create_f3x_returned_bounced_json_file$',
        jsonbuilder.create_f3x_returned_bounced_json_file, name='create_f3x_returned_bounced_json_file'),
    url(r'^core/create_f3x_reattribution_json_file$',
        jsonbuilder.create_f3x_reattribution_json_file, name='create_f3x_reattribution_json_file'),
    url(r'^core/create_inkind_bitcoin_f3x_json_file$',
        jsonbuilder.create_inkind_bitcoin_f3x_json_file, name='create_inkind_bitcoin_f3x_json_file'),
