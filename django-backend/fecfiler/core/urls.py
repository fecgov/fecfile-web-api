...
urlpatterns = [
    ...
    url(
        r"^core/recent_saved_reports$",
        views.recent_saved_reports,
        name="recent_saved_reports",
    ),
    url(
        r"^core/recent_submitted_reports$",
        views.recent_submitted_reports,
        name="recent_submitted_reports",
    ),
