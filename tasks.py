...
APP_NAME = "fecfile-web-api-test"
WEB_SERVICES_NAME = "fecfile-web-services-test"
PROXY_NAME = "fecfile-api-proxy-test"
...
DEPLOY_RULES = (
    ...
    ("dev", lambda _, branch: branch == "feature/780-update-domain-settings"),
)
